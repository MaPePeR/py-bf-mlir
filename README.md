...
To keep more true to the stack I would use for a real programming language a [Lark](https://github.com/lark-parser/lark) based [grammar](py_mlir_brainfuck_compiler/brainfuck.lark) is used to lex and parse the Brainfuck code. To create the MLIR the Python [xDSL](https://github.com/xdslproject/xdsl/) package is used.
